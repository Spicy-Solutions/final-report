...
- [Capítulo IV: Strategic-Level Software Design](#capítulo-iv-strategic-level-software-design)
   ...
   * [4.2. Strategic-Level Domain-Driven Design](#42-strategic-level-domain-driven-design)
      + [4.2.1. EventStorming](#421-event-storming)
      + [4.2.2 Candidate Context Discovery](#422-candidate-context-discovery)
      + [4.2.3. Domain Message Flows Modeling](#423-bdomain-context-discovery)
      + [4.2.4. Bounded Context Canvases](#424-bounded-context-canvases)
      + [4.2.5. Context Mapping](#425-context-mapping)
    * [4.3. Software Architecture](#42-strategic-level-domain-driven-design)
...
- [Capítulo V: Tactical-Level Software Design](#capítulo-v-tactical-level-software-design)
  ...
  + [5.2 Bounded Context: Operations and Monitoring Bounded Context](#52-bounded-context-operations-and-monitoring-bounded-context)
    ...
    - [5.2.6. Bounded Context Software Architecture Code Level Diagrams](#526-bounded-context-software-architecture-code-level-diagrams)
      ...
      * [4.2.2.6.2. Bounded Context Database Design Diagram](#5262-bounded-context-database-design-diagram)
  + [5.3 Bounded Context: Organizational Management Bounded Context](#53-bounded-context-organizational-management-bounded-context)
  ...
  + [5.4. Bounded Context: Commerce Bounded Context](#54-bounded-context-commerce-bounded-context)
    ...
    - [5.4.6. Bounded Context Software Architecture Code Level Diagrams](#546-bounded-context-software-architecture-code-level-diagrams)
      * [5.4.6.1. Bounded Context Domain Layer Class Diagrams](#42461-bounded-context-domain-layer-class-diagrams)
      * [5.4.6.2. Bounded Context Database Design Diagram](#5462-bounded-context-database-design-diagram)
  + [5.5. Bounded Context: Inventory Bounded Context](#55-bounded-context-inventory-bounded-context)
    ...
    - [5.5.6. Bounded Context Software Architecture Code Level Diagrams](#556-bounded-context-software-architecture-code-level-diagrams)
      * [5.5.6.1. Bounded Context Domain Layer Class Diagrams](#42561-bounded-context-domain-layer-class-diagrams)
      * [5.5.6.2. Bounded Context Database Design Diagram](#42562-bounded-context-database-design-diagram)
  + [5.6. Bounded Context: Commmunication Bounded Context](#56-bounded-context-commmunication-bounded-context)
    ...
    - [5.6.6. Bounded Context Software Architecture Code Level Diagrams](#566-bounded-context-software-architecture-code-level-diagrams)
      ...
      * [5.6.6.2. Bounded Context Database Design Diagram](#42662-bounded-context-database-design-diagram)
- [Capítulo VI: Solution UX Design](#capítulo-vi-solution-ui/ux-design)
...
![mauricio me pica](/integrantes/mauricio.png)
...
Leandro comentó que suele usar Booking o Airbnb para reservar hoteles, priorizando la ubicación, el precio y las reseñas antes de decidir. Valora la seguridad, la rapidez y la facilidad de uso de estas apps, además de servicios como Wi-Fi y desayuno. Ha tenido experiencias negativas cuando las fotos no coincidían con la realidad, por lo que ahora revisa con más detalle los comentarios. Considera útil que las aplicaciones recuerden sus preferencias y ofrezcan sugerencias personalizadas, así como poder comunicarse directamente con el hotel desde la app. También valora las cancelaciones flexibles y prefiere reservar en línea por la comodidad y mejores precios. En general, busca una experiencia eficiente, confiable y personalizada al hacer sus reservas.
...
![typography](./assets/img/style-guidelines/typography.png)
...
![logotype](./assets/img/style-guidelines/logotype.png)
...
![colors](./assets/img/style-guidelines/colors.png)

#### Colores de estado:

![status_colors](./assets/img/style-guidelines/status_colors.png)
...
![iot](./assets/img/style-guidelines/device1.png)
...
![device2](./assets/img/style-guidelines/device2.png)
...
- <strong>Visual Hierarchy:</strong> La disposición jerárquica se usa principalmente en la página de inicio y en vistas con información crítica (por ejemplo, disponibilidad de habitaciones por hotel). Se priorizan elementos como la barra de búsqueda, categorías destacadas y tarjetas con imagen, ubicación, nombre y precio, de modo que el usuario identifique con rapidez las mejores alternativas de hospedaje.
...
Se emplean rótulos breves y con significado preciso en las secciones principales:
...
Estas etiquetas buscan exactitud semántica, evitando ambigüedades y tecnicismos innecesarios.

#### b. Asociaciones clave  
Se refuerza la usabilidad asociando cada término con el beneficio esperado para el usuario:

- **"Inventario"** → control de stock, abastecimiento y proveedores.
- **"Planes de Suscripción"** → pagos, gestión de servicios y control financiero.
- **"Alertas"** → notificaciones de seguridad, incidentes y eventos relevantes.
- **"Habitaciones"** → gestión de disponibilidad, limpieza y asignaciones.
- **"Dispositivos"** → sensores, IoT y monitoreo en tiempo real.
...
A continuación se detalla el conjunto de herramientas para el despliegue de cada producto de la solución.
...
<div style="text-align: center;">
  <img src="https://i.imgur.com/YtyyOfv.png" alt="Anatoly Noriega Interview" width="80%" />
</div><br>

<br>

Anatoly comentó que el proceso de registro y creación de perfil desde el celular fue ágil y sencillo. Resaltó que la experiencia al reservar una habitación fue clara y sin dificultades, con pasos intuitivos que le brindaron confianza durante toda la operación. A través del navegador, encontró sin problemas el hotel que buscaba gracias al motor de búsqueda optimizado y los filtros disponibles. Al comparar la versión web con la móvil, indicó que ambas funcionaron correctamente, aunque percibió que la versión web ofrecía una experiencia ligeramente más fluida.

Finalmente, confirmó que la aplicación embebida ajustó automáticamente la temperatura de acuerdo con las preferencias almacenadas en su perfil, un detalle tecnológico que consideró valioso para mejorar su nivel de confort.
